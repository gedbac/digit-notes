...
describe("Outlines", () => {
  ...
  it("should create outline document using factory", () => {
    ...
    expect(document.uncommittedEvents[0].name).to.be.equal("OutlineDocumentCreated");
  ...
  it("should change outline's document title", () => {
    ...
    expect(document.uncommittedEvents.length).to.be.equal(1);
    expect(document.uncommittedEvents[0].name).to.be.equal("OutlineDocumentTitleChanged");
  ...
  it("should mark outline document as deleted", () => {
    ...
    expect(document.uncommittedEvents.length).to.be.equal(1);
    expect(document.uncommittedEvents[0].name).to.be.equal("OutlineDocumentDeleted");
    expect(document.modifiedOn).to.be.equal(document.uncommittedEvents[0].timestamp);
  });
  ...
  it("should add outlines", () => {
    ...
    expect(document.uncommittedEvents[0].name).to.be.equal("OutlineAdded");
    ...
    expect(document.uncommittedEvents[1].name).to.be.equal("OutlineAdded");
  ...
  it("it should remove outlines", () => {
    ...
    expect(document.uncommittedEvents.length).to.be.equal(2);
    expect(document.uncommittedEvents[0].name).to.be.equal("OutlineRemoved");
    expect(document.uncommittedEvents[0].outlineDocumentId).to.be.equal(document.id);
    ...
    expect(document.uncommittedEvents[1].name).to.be.equal("OutlineRemoved");
    expect(document.uncommittedEvents[1].outlineDocumentId).to.be.equal(document.id);
  ...
  it("it should change outline text", () => {
    ...
    expect(document.uncommittedEvents.length).to.be.equal(1);
    expect(document.uncommittedEvents[0].name).to.be.equal("OutlineTextChanged");
    expect(document.uncommittedEvents[0].outlineDocumentId).to.be.equal(document.id);
  ...
  it("it should change outline notes", () => {
    ...
    expect(document.uncommittedEvents.length).to.be.equal(1);
    expect(document.uncommittedEvents[0].name).to.be.equal("OutlineNotesChanged");
    expect(document.uncommittedEvents[0].outlineDocumentId).to.be.equal(document.id);
    expect(document.uncommittedEvents[0].outlineId).to.be.equal(document.children[0].id);
  });
  ...
  it("it should complete outline", () => {
    ...
    expect(document.uncommittedEvents.length).to.be.equal(1);
    expect(document.uncommittedEvents[0].name).to.be.equal("OutlineCompleted");
    expect(document.uncommittedEvents[0].outlineDocumentId).to.be.equal(document.id);
    expect(document.uncommittedEvents[0].outlineId).to.be.equal(document.children[0].id);
  });
  ...
  it("it should incomplete outline", () => {
    ...
    expect(document.uncommittedEvents.length).to.be.equal(1);
    expect(document.uncommittedEvents[0].name).to.be.equal("OutlineIncompleted");
    expect(document.uncommittedEvents[0].outlineDocumentId).to.be.equal(document.id);
    expect(document.uncommittedEvents[0].outlineId).to.be.equal(document.children[0].id);
  });
  ...
  it("it should add tag", () => {
    ...
    expect(document.uncommittedEvents.length).to.be.equal(1);
    expect(document.uncommittedEvents[0].name).to.be.equal("OutlineTagAdded");
    expect(document.uncommittedEvents[0].outlineDocumentId).to.be.equal(document.id);
    expect(document.uncommittedEvents[0].outlineId).to.be.equal(document.children[0].id);
  });
  ...
  it("it should remove tag", () => {
    ...
    expect(document.uncommittedEvents.length).to.be.equal(1);
    expect(document.uncommittedEvents[0].name).to.be.equal("OutlineTagRemoved");
    expect(document.uncommittedEvents[0].outlineDocumentId).to.be.equal(document.id);
    expect(document.uncommittedEvents[0].outlineId).to.be.equal(document.children[0].id);
  });
