...
export default class OutlineDocumentDeleted extends OutlineDocumentEvent {
  ...
  static createFrom({ id = uuid(), name = "OutlineDocumentDeleted", timestamp = getTimestamp(),
    nonce = getRandomValues(16), outlineDocumentId = null } = {}) {
    return new OutlineDocumentDeleted(id, name, timestamp, nonce, outlineDocumentId);
  }
