...
export default class OutlineTagAdded extends OutlineEvent {
  ...
  static createFrom({ id = uuid(), name = "OutlineTagAdded", timestamp = getTimestamp(), nonce = getRandomValues(16),
    outlineDocumentId = null, outlineId = null, outlineTag = null } = {}) {
    return new OutlineTagAdded(id, name, timestamp, nonce, outlineDocumentId, outlineId, outlineTag);
  }
